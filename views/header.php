...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Круши, мочи</div>
            <div class="masthead-heading text-uppercase">не Отступай!</div>
            <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="/login">ПРИНЯТЬ УЧАСТИЕ</a>
        </div>
    </header>
