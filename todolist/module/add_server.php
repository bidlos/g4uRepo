            ...
            if (isset($idAuth)) {
                if ($UserClass->checkUserLogin($idAuth) == TRUE) { ?>
                    ...
                    <div class="modal-body">
                        <form action="<?php $_SERVER['HTTP_HOST'] ?>/todolist/add_server.php" method="post">
                ...
                echo '<div class="modal-body">Для добавления сервера, войдите на сайт при помощи Telegram!</div>';
            }?>
        </div>
    </div>
</div>